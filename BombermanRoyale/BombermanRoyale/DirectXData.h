...
struct DIFFUSE_TEXTURES
{
	enum {
		...
		CHARACTER_SCREEN2, CHARACTER_SCREE3, CHARACTER_SCREEN4, CHARACTER_SCREEN5, CHARACTER_SCREEN6, CHARACTER_SCREEN7, CHARACTER_SCREEN8, ARCADE_BUTTON, OP1, OP2, OP3, OP4, OP5, OP6, OP7,
