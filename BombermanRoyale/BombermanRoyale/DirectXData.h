...
struct DIFFUSE_TEXTURES
{
	enum {
		...
		BOSS_RETICLE, CREDITS_SCREEN, HELP_MENU, ARCADE_MENU, ARCADE_MENU2, ARCADE_MENU3, ARCADE_MENU4, ARCADE_MENU5, ARCADE_MENU6, ARCADE_MENU7, ARCADE_MENU8, ARCADE_MENU9, CHARACTER_SCREEN1, 
		...
		FIRE_WALL2, FIRE_WALL3, FIRE_WALL4, FIRE_WALL5, FIRE_WALL6, FIRE_WALL7, FIRE_WALL8, FIRE_WALL9, FIRE_WALL10, FIRE_WALL11, FIRE_WALL12, FIRE_WALL13, GOAT, BOAR, BOAR2,
		MAIN_MENU_1, ARCADE_MENU_1 = 144, ARCADE_MENU_END = 251, COUNT
