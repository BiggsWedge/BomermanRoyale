...
struct GRID_SYSTEM
{
	enum { FREE, DESTROYABLE, CRATE, BOMB, EXPLOSION_RADIUS, PLAYER, POWERUP, AI_PLAYER1, AI_PLAYER2, COUNT };
};
...
struct DIFFUSE_TEXTURES
{
	enum {
		...
		BOSS_RETICLE, CREDITS_SCREEN, OPTIONS_MENU, HELP_MENU, ARCADE_MENU, ARCADE_MENU2, ARCADE_MENU3, ARCADE_MENU4, ARCADE_MENU5, ARCADE_MENU6, ARCADE_MENU7, ARCADE_MENU8, ARCADE_MENU9, CHARACTER_SCREEN1,
		CHARACTER_SCREEN2, CHARACTER_SCREE3, CHARACTER_SCREEN4, CHARACTER_SCREEN5, CHARACTER_SCREEN6, CHARACTER_SCREEN7, CHARACTER_SCREEN8, ARCADE_BUTTON, OP1, OP2, OP3, OP3, OP4, OP5, OP6, OP7,
		BATTLE_BUTTON, OPTIONS_BUTTON, EXIT_BUTTON, RED_TEX, BLUE_TEX, BLACK_TEX, FIRE_TEX, LAVA, HAY_TEX, BOMB, BOMB2, BOMB3, BOMB4, BOMB5, CHICKEN1, CHICKEN2, CHICKEN3, CHICKEN4, FIRE_WALL1,
		FIRE_WALL2, FIRE_WALL3, FIRE_WALL4, FIRE_WALL5, FIRE_WALL6, FIRE_WALL7, FIRE_WALL8, FIRE_WALL9, FIRE_WALL10, FIRE_WALL11, FIRE_WALL12, FIRE_WALL13, EXPL_1, EXPL_2, EXPL_3, EXPL_4, EXPL_5, EXPL_6, EXPL_7, EXPL_8, EXPL_9, EXPL_10, EXPL11, EXPL_12, EXPL_13, EXPL_14,
		GOAT, BOAR, BOAR2, CHICKEN_NORMAL, GOAT_NORMAL, BOAR_NORMAL,
		MAIN_MENU_1, ARCADE_MENU_1 = 165, ARCADE_MENU_END = 272, COUNT
	};
};

struct BLEND_STATE
{
	enum { DEFAULT, UI, TRANSPARENCY, COUNT };
};
