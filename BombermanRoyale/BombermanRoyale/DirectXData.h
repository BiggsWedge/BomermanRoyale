...
{
	enum { V_BASIC = 0, V_LINE, P_BASIC, P_LINE, MVP_t, LIGHTS, JOINTS, MATERIAL, BOMBCONST, BOMB_P_CONST, COUNT };
};
...
{
	enum { BASIC = 0, LINE, ANIM, BOMB, COUNT };
};
...
struct DIFFUSE_TEXTURES
{
	enum {
		...
		RED_TEX, BLUE_TEX, BLACK_TEX, FIRE_TEX, HAY_TEX, BOMB, BOMB2, BOMB3, BOMB4,
		CHICKEN1, CHICKEN2, CHICKEN3, CHICKEN4, TEST_BUTTON, COUNT
	};
};
