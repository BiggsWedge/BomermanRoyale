...
{
	enum {
		CRATE = 0, BATTLE_MAGE, MAIN_MENU, MAIN_MENU2, HUD, NAMES_HUD, PLAYER_1_WIN, PLAYER_2_WIN, PLAYER_3_WIN, PLAYER_4_WIN, DRAW_SCREEN, LOADING_SCREEN, DC1, DC2, DC3, D4, PAUSE_MENU,
