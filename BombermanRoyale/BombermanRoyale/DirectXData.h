...
struct DIFFUSE_TEXTURES
{
	enum {
		...
		BATTLE_BUTTON, OPTIONS_BUTTON, EXIT_BUTTON, OP1, OP2, OP3, OP4, OP5, OP6, OP7, RED_TEX, BLUE_TEX, BLACK_TEX, FIRE_TEX, LAVA, HAY_TEX, BOMB, BOMB2, BOMB3, BOMB4, BOMB5, CHICKEN1, CHICKEN2, CHICKEN3, CHICKEN4, FIRE_WALL1,
		...
		MAIN_MENU_1, ARCADE_MENU_1 = 172, ARCADE_MENU_END = 279, COUNT
	};
};
