...
struct DIFFUSE_TEXTURES
{
	enum {
		...
		CHARACTER_SCREEN2, CHARACTER_SCREE3, CHARACTER_SCREEN4, CHARACTER_SCREEN5, CHARACTER_SCREEN6, CHARACTER_SCREEN7, CHARACTER_SCREEN8, MENU_NAV1,
		MENU_NAV2, OPTIONS_BUTTON, EXIT_BUTTON, OP1, OP2, OP3, OP4, OP5, OP6, OP7, RED_TEX, BLUE_TEX, BLACK_TEX, FIRE_TEX, LAVA, HAY_TEX, BOMB, BOMB2, BOMB3, BOMB4, BOMB5, CHICKEN1, CHICKEN2, CHICKEN3, CHICKEN4, FIRE_WALL1,
		...
		MAIN_MENU_1, ARCADE_MENU_1 = 179, ARCADE_MENU_END = 286, COUNT
	};
};
