...
struct DIFFUSE_TEXTURES
{
	enum {
		...
		BOSS_RETICLE, HELP_MENU, ARCADE_MENU, ARCADE_MENU2, ARCADE_MENU3, ARCADE_MENU4, ARCADE_MENU5, ARCADE_MENU6, ARCADE_MENU7, ARCADE_MENU8, ARCADE_MENU9, CHARACTER_SCREEN1, 
