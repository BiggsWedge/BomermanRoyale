...
{
	enum {
		CRATE = 0, BATTLE_MAGE, MAIN_MENU, HUD, NAMES_HUD, PLAYER_1_WIN, PLAYER_2_WIN, PLAYER_3_WIN, 
		PLAYER_4_WIN, DRAW_SCREEN, LOADING_SCREEN, DC1, DC2, DC3, D4, PAUSE_MENU,
		HELP_MENU, ARCADE_MENU, ARCADE_BUTTON, BATTLE_BUTTON, OPTIONS_BUTTON, EXIT_BUTTON,
