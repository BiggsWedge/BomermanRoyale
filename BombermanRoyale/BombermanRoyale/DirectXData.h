...
{
	enum {
		CRATE = 0, BATTLE_MAGE, MAIN_MENU, MAIN_MENU2, HUD, NAMES_HUD, PLAYER_1_WIN, PLAYER_2_WIN, PLAYER_3_WIN, PLAYER_4_WIN, DRAW_SCREEN, PAUSE_MENU,
		...
		BATTLE_BUTTON, OPTIONS_BUTTON, EXIT_BUTTON, RED_TEX, BLUE_TEX, BLACK_TEX, FIRE_TEX, HAY_TEX, BOMB, BOMB3, BOMB2, BOMB4, CHICKEN1, CHICKEN2,
