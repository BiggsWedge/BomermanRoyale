...
struct DIFFUSE_TEXTURES
{
	enum {
		...
		FIRE_WALL2, FIRE_WALL3, FIRE_WALL4, FIRE_WALL5, FIRE_WALL6, FIRE_WALL7, FIRE_WALL8, FIRE_WALL9, FIRE_WALL10, FIRE_WALL11, FIRE_WALL12, FIRE_WALL13, GOAT, BOAR, BOAR2, CHICKEN_NORMAL, GOAT_NORMAL,
		BOAR_NORMAL, COUNT
	};
};
