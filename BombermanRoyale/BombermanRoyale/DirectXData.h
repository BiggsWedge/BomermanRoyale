...
struct DIFFUSE_TEXTURES
{
	enum {
		...
		MENU_NAV2, OPTIONS_BUTTON, EXIT_BUTTON, RED_TEX, BLUE_TEX, BLACK_TEX, FIRE_TEX, LAVA, HAY_TEX, BOMB, BOMB2, BOMB3, BOMB4, BOMB5, CHICKEN1, CHICKEN2, CHICKEN3, CHICKEN4, FIRE_WALL1,
