...
bool CObject::TurnPlayerTo(float _x, float _z) {
...
bool CObject::MoveOverTime(float start_x, float end_x, float start_z, float end_z,static float timepassed, bool rotation)
{
	float ratio = 0.0f;
	movetimer = 0.0f;
	//if (!moving)
